...
3. **Unsubscribe protection.** Reply-based opt-outs remain enabled. A visible unsubscribe link must be present for scalable outreach, and one-click unsubscribe must be used when supported. Opt-outs are durable suppressions across remaps, imports, campaigns, and provider migrations.
